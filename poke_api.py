...
# Extract the artworkk URL from the info dictionary
...
print(f'Downloading artwork for {pokemon_name.capitalize()}...', end='') image_data = image_lib.download_image(artwork_url)
